...
public class SwingResult {
    ...
    /**
     * <code>expectedNumber</code> 값이 <code>baseBall</code>의 <code>i</code> 인덱스 위치의 존재하지 않으면서 다른 위치에 존재할 경우 <code>ballCount</code> 를 증가하여 반환합니다.
     *
     * @param baseBall       투구번호
     ...
     */
    private static int countUpIfBall(final BaseBall baseBall, final int expectedNumber, final int i, final int ballCount) {
    ...
    /**
     * <code>expectedNumber</code> 값이 <code>baseBall</code>의 <code>i</code> 인덱스 위치에 존재할 경우 <code>strikeCount</code> 를 증가하여 반환합니다.
     *
     * @param baseBall       투구번호
     * @param expectedNumber 예상숫자
     * @param i              투구번호의 인덱스
     ...
     */
    private static int countUpIfStrike(final BaseBall baseBall, final int expectedNumber, final int i, final int strikeCount) {
