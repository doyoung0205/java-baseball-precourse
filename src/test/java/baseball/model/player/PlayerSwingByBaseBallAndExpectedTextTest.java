...
@Tag("Player")
@DisplayName("Player swingByBaseBallAndExpectedText 메서드 테스트")
public class PlayerSwingByBaseBallAndExpectedTextTest {
	...
	void 스윙결과가_낫싱인_경우(final String textBaseBall, final String expectedTextBaseBall) throws
		...
		final SwingResult swingResult = player.swingByBaseBallAndExpectedText(baseBall, expectedTextBaseBall);
		// when
